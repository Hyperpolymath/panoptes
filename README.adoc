...
:experimental:
:url-github: https://github.com/hyperpolymath/Panoptes
:url-gitlab: https://gitlab.com/hyperpolymath/Panoptes
:url-bitbucket: https://bitbucket.org/hyperpolymath/Panoptes
:url-codeberg: https://codeberg.org/hyperpolymath/Panoptes
...
Panoptes is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
